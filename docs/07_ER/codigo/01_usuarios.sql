...
CREATE VIEW v_cuentas_activas AS
SELECT id, nombre, correo, pais, rol, creado_en, actualizado_en
FROM cuentas
WHERE eliminado_en IS NULL;

CREATE VIEW v_perfiles_disponibles AS
...
CREATE INDEX idx_perfiles_cuenta ON perfiles(cuenta_id);
CREATE INDEX idx_sesiones_cuenta ON sesiones(cuenta_id);
CREATE INDEX idx_usuarios_instantaneas_tabla ON instantaneas(tabla_origen, entidad_id);
