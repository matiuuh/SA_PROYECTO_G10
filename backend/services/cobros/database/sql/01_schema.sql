...
BEGIN
    IF TG_OP = 'DELETE' THEN
        ...
        v_actor := COALESCE(
            ...
            (SELECT cuenta_id FROM transacciones WHERE id = NULLIF(v_row->>'transaccion_id', '')::UUID)
        );
        INSERT INTO instantaneas (tabla_origen, entidad_id, evento, estado_anterior, estado_nuevo, usuario_accion, fecha_evento)
